...
Then, for purpose of control, I sample the same number of A sites and RRACH sites on the exonic regions mapped with the m6A sites above.
...
Random_RRACH <-  m6ALogisticModel::Sample_sequence("RRACH",  Subset_regions , Hsapiens, N = Num) - 2
Random_A <-  m6ALogisticModel::Sample_sequence("A",  Subset_regions , Hsapiens, N = Num)
```

Merge the 3 GRanges into a Summarized Experiment
```{r}
...
- May best include a control collumn that is to.... randomly shuffled position aside 100bp ect.
